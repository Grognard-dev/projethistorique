...
background: linear-gradient(rgba(255, 255, 255, 0.15),rgba(255, 255, 255, 0.25),  rgba(255, 255, 255, 0.25)), 
    ...
    max-height: 300px; box-shadow: 0 -4px 5px 4.5px rgba(0,0,0,0.3), inset 0 0 16px -5px rgba(0,0,0,0.3); ">
    <h1 style="font-size: 6vw;
    background: radial-gradient(#00000040,#00000020,#00000000, #00000000);
    width: 100vw;
    height: 9vw;
    text-align: center;
